		...
		<Wrapper>
			<ContentLeft>
				<Typography variant="h1" fontSize="2rem" color=" #0A1929">
					The React
					<Typography variant="span" style={{ color: " #007FFF", fontWeight: "700" }}>
						UI library
					</Typography>
					you always wanted
				</Typography>
				...
				<Button to="/components/usage">Get started  <Typography variant="span"
				 style={{ marginLeft: '2rem', color: 'white',display: "inline"  }}>&gt;</Typography></Button>
			</ContentLeft>
			<ContentRight>
				<Content>
